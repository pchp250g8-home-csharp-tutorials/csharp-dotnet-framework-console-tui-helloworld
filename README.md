...
The program does the following:
  ...
  4. Displays the second inscription "С# DotNet FrameWork Platform!!!" in column 10 and row 11.
  5. Waiting for a key to be pressed.
  6. Exits.

HelloWorld. Занятия по С#. Расширинные возможности консоли. Платформа DotNet FrameWork. Текстовый интерфейс пользователя. Консольное приложение.
Программа делает следующее:
  ...
  4. Выводит на экран вторую надпись "С# DotNet FrameWork Platform!!!" в 10 столбце и 11 строке.
